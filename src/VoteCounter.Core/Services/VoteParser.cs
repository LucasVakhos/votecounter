...
/// </summary>
/// <remarks>
/// Extracts voter names and vote pairs (work numbers and scores) from text input.
...
public sealed class VoteParser
{
    ...
    /// <summary>
    /// Parses vote text into an ImportResult containing vote blocks and validation warnings.
    /// </summary>
    /// <param name="text">Raw text input containing voter names and vote scores.</param>
    /// <param name="contestId">The ID of the contest these votes belong to.</param>
    /// <param name="contest">Optional contest context for validation (work numbers, vote limits).</param>
    /// <returns>ImportResult with parsed vote blocks and any validation warnings.</returns>
