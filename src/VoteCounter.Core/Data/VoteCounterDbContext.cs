...
namespace VoteCounter.Core.Data;

/// <summary>
/// Entity Framework Core DbContext для VoteCounter
/// </summary>
public sealed class VoteCounterDbContext : DbContext
{
    public VoteCounterDbContext(DbContextOptions<VoteCounterDbContext> options)
        : base(options)
    {
    }
